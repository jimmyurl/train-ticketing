...
class Tickets extends StatelessWidget {
  final Map<String, dynamic>? ticket; // Changed to nullable
  final bool? isColor;
                          ...
                          child: DecoratedBox(
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.only(
                                ...
                                bottomRight:
                                    Radius.circular(Layout.getHeight(10)),
                              ),
                            ),
                          ),
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                Text(
                                  ticket!['number']?.toString() ?? 'Unknown',
                                  style: isColor == null
                                      ? TextStyles.headline3
                                          .copyWith(color: ColorManager.white)
                                      : TextStyles.headline3
